...
class PostPaymentPriceTableResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PostPaymentPriceTableResponse &&
  ...
  @override
  String toString() => 'PostPaymentPriceTableResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, paymentConditionId=$paymentConditionId, priceTableId=$priceTableId, externalCode=$externalCode, status=$status]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PostPaymentPriceTableResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PostPaymentPriceTableResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostPaymentPriceTableResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PostPaymentPriceTableResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PostPaymentPriceTableResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostPaymentPriceTableResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
