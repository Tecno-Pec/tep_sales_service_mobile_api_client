...
class PostDiscountWeightResponse {
  /// Returns a new [PostDiscountWeightResponse] instance.
  ...
  /// Returns a new [PostDiscountWeightResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostDiscountWeightResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PostDiscountWeightResponse(
  ...
  static List<PostDiscountWeightResponse> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostDiscountWeightResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostDiscountWeightResponse> mapFromJson(dynamic json) {
    final map = <String, PostDiscountWeightResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostDiscountWeightResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
