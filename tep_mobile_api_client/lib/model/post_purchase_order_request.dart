...
class PostPurchaseOrderRequest {
  /// Returns a new [PostPurchaseOrderRequest] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is PostPurchaseOrderRequest &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.distribuitionCenterClientAddressId != null) {
      json[r'distribuitionCenterClientAddressId'] =
          this.distribuitionCenterClientAddressId;
    } else {
  ...
  /// Returns a new [PostPurchaseOrderRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostPurchaseOrderRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostPurchaseOrderRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostPurchaseOrderRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PostPurchaseOrderRequest(
        ...
        freightCompositions:
            FreightCompositionModel.listFromJson(json[r'freightCompositions']),
        mobileCreatedUserId:
            mapValueOfType<String>(json, r'mobileCreatedUserId'),
        paymentPriceTableId:
            mapValueOfType<String>(json, r'paymentPriceTableId'),
        distribuitionCenterId:
            mapValueOfType<String>(json, r'distribuitionCenterId'),
        distribuitionCenterClientAddressId:
            mapValueOfType<String>(json, r'distribuitionCenterClientAddressId'),
      );
    }
    return null;
  }

  static List<PostPurchaseOrderRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <PostPurchaseOrderRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostPurchaseOrderRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostPurchaseOrderRequest> mapFromJson(dynamic json) {
    final map = <String, PostPurchaseOrderRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostPurchaseOrderRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PostPurchaseOrderRequest-objects as value to a dart map
  static Map<String, List<PostPurchaseOrderRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<PostPurchaseOrderRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostPurchaseOrderRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
