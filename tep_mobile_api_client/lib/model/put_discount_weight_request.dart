...
class PutDiscountWeightRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PutDiscountWeightRequest &&
  ...
  @override
  String toString() => 'PutDiscountWeightRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, quantity=$quantity, percent=$percent]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PutDiscountWeightRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PutDiscountWeightRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PutDiscountWeightRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PutDiscountWeightRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PutDiscountWeightRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PutDiscountWeightRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
