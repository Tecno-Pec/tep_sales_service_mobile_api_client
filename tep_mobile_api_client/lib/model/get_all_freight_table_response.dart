...
class GetAllFreightTableResponse {
  /// Returns a new [GetAllFreightTableResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetAllFreightTableResponse &&
  ...
  @override
  String toString() => 'GetAllFreightTableResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, externalCode=$externalCode, id=$id, paymentConditionId=$paymentConditionId, vehicleTypeId=$vehicleTypeId, initialKilometer=$initialKilometer, finalKilometer=$finalKilometer, value=$value, isFractional=$isFractional, operationType=$operationType, status=$status]';
  ...
  /// Returns a new [GetAllFreightTableResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllFreightTableResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetAllFreightTableResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetAllFreightTableResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return GetAllFreightTableResponse(
  ...
  static List<GetAllFreightTableResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetAllFreightTableResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllFreightTableResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetAllFreightTableResponse> mapFromJson(dynamic json) {
    final map = <String, GetAllFreightTableResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetAllFreightTableResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetAllFreightTableResponse-objects as value to a dart map
  static Map<String, List<GetAllFreightTableResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetAllFreightTableResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetAllFreightTableResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
