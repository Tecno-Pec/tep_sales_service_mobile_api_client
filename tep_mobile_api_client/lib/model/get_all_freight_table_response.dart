...
class GetAllFreightTableResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetAllFreightTableResponse &&
  ...
  @override
  String toString() =>
      'GetAllFreightTableResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, externalCode=$externalCode, id=$id, paymentConditionId=$paymentConditionId, vehicleTypeId=$vehicleTypeId, initialKilometer=$initialKilometer, finalKilometer=$finalKilometer, value=$value, isFractional=$isFractional, operationType=$operationType, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetAllFreightTableResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetAllFreightTableResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetAllFreightTableResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<GetAllFreightTableResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetAllFreightTableResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
