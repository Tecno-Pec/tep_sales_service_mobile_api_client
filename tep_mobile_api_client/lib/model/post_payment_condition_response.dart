...
class PostPaymentConditionResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PostPaymentConditionResponse &&
  ...
  @override
  String toString() => 'PostPaymentConditionResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, name=$name, externalCode=$externalCode, sequence=$sequence, status=$status]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PostPaymentConditionResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PostPaymentConditionResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostPaymentConditionResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PostPaymentConditionResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PostPaymentConditionResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostPaymentConditionResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
