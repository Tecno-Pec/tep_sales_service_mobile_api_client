...
class PutDiscountRuleRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is PutDiscountRuleRequest &&
  ...
  @override
  String toString() =>
      'PutDiscountRuleRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, discountWeightType=$discountWeightType, minQuantity=$minQuantity, discountType=$discountType, referenceType=$referenceType, referenceId=$referenceId, discount=$discount, externalCode=$externalCode, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PutDiscountRuleRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PutDiscountRuleRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PutDiscountRuleRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PutDiscountRuleRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PutDiscountRuleRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
