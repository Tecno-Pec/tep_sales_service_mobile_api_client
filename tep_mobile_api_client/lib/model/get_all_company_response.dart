...
class GetAllCompanyResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetAllCompanyResponse &&
  ...
  @override
  String toString() =>
      'GetAllCompanyResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, name=$name, document=$document]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetAllCompanyResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetAllCompanyResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetAllCompanyResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<GetAllCompanyResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetAllCompanyResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
