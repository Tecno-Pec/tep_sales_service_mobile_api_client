...
class GetAllFreightConversionFactorResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetAllFreightConversionFactorResponse &&
  ...
  @override
  String toString() =>
      'GetAllFreightConversionFactorResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, productId=$productId, vehicleTypeId=$vehicleTypeId, weightkilograms=$weightkilograms, externalCode=$externalCode, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetAllFreightConversionFactorResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetAllFreightConversionFactorResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetAllFreightConversionFactorResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, GetAllFreightConversionFactorResponse> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            GetAllFreightConversionFactorResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<GetAllFreightConversionFactorResponse>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetAllFreightConversionFactorResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
