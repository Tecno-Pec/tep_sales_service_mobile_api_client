...
class PostUserSignInRequest {
  /// Returns a new [PostUserSignInRequest] instance.
  ...
  /// Returns a new [PostUserSignInRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostUserSignInRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PostUserSignInRequest> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostUserSignInRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostUserSignInRequest> mapFromJson(dynamic json) {
    final map = <String, PostUserSignInRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostUserSignInRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
