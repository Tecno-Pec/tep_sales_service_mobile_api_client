...
class PostDiscountRuleResponse {
  /// Returns a new [PostDiscountRuleResponse] instance.
  ...
  /// Returns a new [PostDiscountRuleResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostDiscountRuleResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PostDiscountRuleResponse(
  ...
  static List<PostDiscountRuleResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostDiscountRuleResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostDiscountRuleResponse> mapFromJson(dynamic json) {
    final map = <String, PostDiscountRuleResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostDiscountRuleResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
