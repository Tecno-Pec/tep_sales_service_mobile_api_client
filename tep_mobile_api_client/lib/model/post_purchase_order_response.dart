...
class PostPurchaseOrderResponse {
  /// Returns a new [PostPurchaseOrderResponse] instance.
  ...
  /// Returns a new [PostPurchaseOrderResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostPurchaseOrderResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PostPurchaseOrderResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostPurchaseOrderResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostPurchaseOrderResponse> mapFromJson(dynamic json) {
    final map = <String, PostPurchaseOrderResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostPurchaseOrderResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
