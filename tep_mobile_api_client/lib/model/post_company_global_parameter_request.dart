...
class PostCompanyGlobalParameterRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is PostCompanyGlobalParameterRequest &&
  ...
  @override
  String toString() =>
      'PostCompanyGlobalParameterRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, name=$name, companyId=$companyId, discountRuleByBudget=$discountRuleByBudget]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostCompanyGlobalParameterRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostCompanyGlobalParameterRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostCompanyGlobalParameterRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, PostCompanyGlobalParameterRequest> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<PostCompanyGlobalParameterRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PostCompanyGlobalParameterRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
