...
class PostVehicleTypeResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PostVehicleTypeResponse &&
  ...
  @override
  String toString() =>
      'PostVehicleTypeResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, name=$name, capacity=$capacity, maxCapacity=$maxCapacity, externalCode=$externalCode, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostVehicleTypeResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostVehicleTypeResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostVehicleTypeResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PostVehicleTypeResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PostVehicleTypeResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
