...
class GetAllProductResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetAllProductResponse &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetAllProductResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetAllProductResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetAllProductResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GetAllProductResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetAllProductResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetAllProductResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
