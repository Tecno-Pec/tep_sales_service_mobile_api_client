...
class PostRefusedPurchaseOrderRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PostRefusedPurchaseOrderRequest &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PostRefusedPurchaseOrderRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PostRefusedPurchaseOrderRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostRefusedPurchaseOrderRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, PostRefusedPurchaseOrderRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<PostRefusedPurchaseOrderRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PostRefusedPurchaseOrderRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostRefusedPurchaseOrderRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
