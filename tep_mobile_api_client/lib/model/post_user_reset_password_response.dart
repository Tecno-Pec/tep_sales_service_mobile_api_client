...
class PostUserResetPasswordResponse {
  /// Returns a new [PostUserResetPasswordResponse] instance.
  ...
  /// Returns a new [PostUserResetPasswordResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostUserResetPasswordResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PostUserResetPasswordResponse(
  ...
  static List<PostUserResetPasswordResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostUserResetPasswordResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostUserResetPasswordResponse> mapFromJson(dynamic json) {
    final map = <String, PostUserResetPasswordResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostUserResetPasswordResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
