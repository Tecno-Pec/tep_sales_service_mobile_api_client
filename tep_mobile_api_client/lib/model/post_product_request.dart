...
class PostProductRequest {
  /// Returns a new [PostProductRequest] instance.
  PostProductRequest({
    this.createdAt,
    this.updatedAt,
    this.userCreated,
  ...
  /// Returns a new [PostProductRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostProductRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PostProductRequest> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostProductRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostProductRequest> mapFromJson(dynamic json) {
    final map = <String, PostProductRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostProductRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
