...
class VehicleTypeStatus {
  ...
  static const number0 = VehicleTypeStatus._(0);
  static const number1 = VehicleTypeStatus._(1);

  /// List of all possible values in this [enum][VehicleTypeStatus].
  static const values = <VehicleTypeStatus>[
    number0,
    number1,
  ];
  ...
  static List<VehicleTypeStatus> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VehicleTypeStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class VehicleTypeStatusTypeTransformer {
  ...
  int encode(VehicleTypeStatus data) => data.value;

  /// Decodes a [dynamic value][data] to a VehicleTypeStatus.
  ///
