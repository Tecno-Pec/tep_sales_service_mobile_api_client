...
class GetAllAuditResponse {
  /// Returns a new [GetAllAuditResponse] instance.
  GetAllAuditResponse({
    this.createdAt,
    this.updatedAt,
    this.userCreated,
  ...
  /// Returns a new [GetAllAuditResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllAuditResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetAllAuditResponse(
        ...
        action: ActionType.fromJson(json[r'action']),
  ...
  static List<GetAllAuditResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllAuditResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetAllAuditResponse> mapFromJson(dynamic json) {
    final map = <String, GetAllAuditResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetAllAuditResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
