...
class PostIntegrationStatusResponse {
  /// Returns a new [PostIntegrationStatusResponse] instance.
  ...
  /// Returns a new [PostIntegrationStatusResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostIntegrationStatusResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PostIntegrationStatusResponse(
  ...
  static List<PostIntegrationStatusResponse> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostIntegrationStatusResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostIntegrationStatusResponse> mapFromJson(dynamic json) {
    final map = <String, PostIntegrationStatusResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostIntegrationStatusResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
