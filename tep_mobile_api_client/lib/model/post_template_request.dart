...
class PostTemplateRequest {
  ...
  @override
  String toString() =>
      'PostTemplateRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, name=$name, businessId=$businessId]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostTemplateRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostTemplateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostTemplateRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PostTemplateRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PostTemplateRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
