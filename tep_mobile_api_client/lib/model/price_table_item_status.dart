...
class PriceTableItemStatus {
  ...
  static const number0 = PriceTableItemStatus._(0);
  static const number1 = PriceTableItemStatus._(1);

  /// List of all possible values in this [enum][PriceTableItemStatus].
  static const values = <PriceTableItemStatus>[
    number0,
    number1,
  ];
  ...
  static List<PriceTableItemStatus> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PriceTableItemStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class PriceTableItemStatusTypeTransformer {
  ...
  int encode(PriceTableItemStatus data) => data.value;

  /// Decodes a [dynamic value][data] to a PriceTableItemStatus.
  ///
