...
class PutFreightTableRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is PutFreightTableRequest &&
  ...
  @override
  String toString() =>
      'PutFreightTableRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, externalCode=$externalCode, id=$id, paymentConditionId=$paymentConditionId, vehicleTypeId=$vehicleTypeId, initialKilometer=$initialKilometer, finalKilometer=$finalKilometer, value=$value, isFractional=$isFractional, operationType=$operationType, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PutFreightTableRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PutFreightTableRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PutFreightTableRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PutFreightTableRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PutFreightTableRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
