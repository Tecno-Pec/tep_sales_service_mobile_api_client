...
class GetAllPagedCompanyGlobalParameterResponse {
  /// Returns a new [GetAllPagedCompanyGlobalParameterResponse] instance.
  ...
  /// Returns a new [GetAllPagedCompanyGlobalParameterResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllPagedCompanyGlobalParameterResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetAllPagedCompanyGlobalParameterResponse(
  ...
  static List<GetAllPagedCompanyGlobalParameterResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllPagedCompanyGlobalParameterResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
