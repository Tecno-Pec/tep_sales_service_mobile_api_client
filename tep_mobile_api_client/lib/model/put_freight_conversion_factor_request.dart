...
class PutFreightConversionFactorRequest {
  /// Returns a new [PutFreightConversionFactorRequest] instance.
  ...
  /// Returns a new [PutFreightConversionFactorRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PutFreightConversionFactorRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PutFreightConversionFactorRequest(
  ...
  static List<PutFreightConversionFactorRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PutFreightConversionFactorRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PutFreightConversionFactorRequest> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = PutFreightConversionFactorRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
