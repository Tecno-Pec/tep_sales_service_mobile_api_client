...
class PostUserForceChangePasswordRequest {
  /// Returns a new [PostUserForceChangePasswordRequest] instance.
  ...
  /// Returns a new [PostUserForceChangePasswordRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostUserForceChangePasswordRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PostUserForceChangePasswordRequest(
  ...
  static List<PostUserForceChangePasswordRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostUserForceChangePasswordRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostUserForceChangePasswordRequest> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = PostUserForceChangePasswordRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
