...
class GetAllDiscountRuleResponse {
  /// Returns a new [GetAllDiscountRuleResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetAllDiscountRuleResponse &&
  ...
  @override
  String toString() => 'GetAllDiscountRuleResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, discountWeightType=$discountWeightType, minQuantity=$minQuantity, discountType=$discountType, referenceType=$referenceType, referenceId=$referenceId, discount=$discount, externalCode=$externalCode, status=$status]';
  ...
  /// Returns a new [GetAllDiscountRuleResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllDiscountRuleResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetAllDiscountRuleResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetAllDiscountRuleResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return GetAllDiscountRuleResponse(
  ...
  static List<GetAllDiscountRuleResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetAllDiscountRuleResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllDiscountRuleResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetAllDiscountRuleResponse> mapFromJson(dynamic json) {
    final map = <String, GetAllDiscountRuleResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetAllDiscountRuleResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetAllDiscountRuleResponse-objects as value to a dart map
  static Map<String, List<GetAllDiscountRuleResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetAllDiscountRuleResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetAllDiscountRuleResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
