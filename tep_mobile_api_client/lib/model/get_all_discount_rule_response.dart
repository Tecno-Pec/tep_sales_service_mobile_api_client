...
class GetAllDiscountRuleResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetAllDiscountRuleResponse &&
  ...
  @override
  String toString() =>
      'GetAllDiscountRuleResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, discountWeightType=$discountWeightType, minQuantity=$minQuantity, discountType=$discountType, referenceType=$referenceType, referenceId=$referenceId, discount=$discount, externalCode=$externalCode, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetAllDiscountRuleResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetAllDiscountRuleResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetAllDiscountRuleResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<GetAllDiscountRuleResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetAllDiscountRuleResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
