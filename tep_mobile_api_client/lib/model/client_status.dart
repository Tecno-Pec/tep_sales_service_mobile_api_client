...
class ClientStatus {
  ...
  static const number0 = ClientStatus._(0);
  static const number1 = ClientStatus._(1);
  static const number2 = ClientStatus._(2);

  /// List of all possible values in this [enum][ClientStatus].
  static const values = <ClientStatus>[
    number0,
    number1,
    number2,
  ];
  ...
  static List<ClientStatus> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ClientStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class ClientStatusTypeTransformer {
  ...
  int encode(ClientStatus data) => data.value;

  /// Decodes a [dynamic value][data] to a ClientStatus.
  ///
