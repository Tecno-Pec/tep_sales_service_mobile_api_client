...
class PostPriceTableRequest {
  /// Returns a new [PostPriceTableRequest] instance.
  ...
  /// Returns a new [PostPriceTableRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostPriceTableRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PostPriceTableRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostPriceTableRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostPriceTableRequest> mapFromJson(dynamic json) {
    final map = <String, PostPriceTableRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostPriceTableRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
