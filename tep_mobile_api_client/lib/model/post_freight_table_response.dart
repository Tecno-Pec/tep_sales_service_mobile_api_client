...
class PostFreightTableResponse {
  /// Returns a new [PostFreightTableResponse] instance.
  ...
  /// Returns a new [PostFreightTableResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostFreightTableResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PostFreightTableResponse(
  ...
  static List<PostFreightTableResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostFreightTableResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostFreightTableResponse> mapFromJson(dynamic json) {
    final map = <String, PostFreightTableResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostFreightTableResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
