...
class ProductEspecification {
  ...
  bool operator ==(Object other) =>
      ...
      other is ProductEspecification &&
          other.key == key &&
          other.value == value;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ProductEspecification[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ProductEspecification[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProductEspecification> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ProductEspecification>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ProductEspecification.listFromJson(
          entry.value,
          growable: growable,
        );
      }
