...
class DatabaseCollector {
  ...
  @override
  String toString() =>
      'DatabaseCollector[outPutFolder=$outPutFolder, connection=$connection, queries=$queries]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DatabaseCollector[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DatabaseCollector[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DatabaseCollector> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DatabaseCollector>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DatabaseCollector.listFromJson(
          entry.value,
          growable: growable,
        );
      }
