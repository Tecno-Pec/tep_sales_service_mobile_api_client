...
class GetAllPagedIntegrationStatusResponse {
  /// Returns a new [GetAllPagedIntegrationStatusResponse] instance.
  ...
  /// Returns a new [GetAllPagedIntegrationStatusResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllPagedIntegrationStatusResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetAllPagedIntegrationStatusResponse(
        ...
        results: GetAllIntegrationStatusResponse.listFromJson(json[r'results']),
      );
    }
    return null;
  }
  ...
  static List<GetAllPagedIntegrationStatusResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllPagedIntegrationStatusResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
