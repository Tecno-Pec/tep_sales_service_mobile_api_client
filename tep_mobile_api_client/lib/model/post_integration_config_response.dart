...
class PostIntegrationConfigResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PostIntegrationConfigResponse &&
  ...
  @override
  String toString() =>
      'PostIntegrationConfigResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, timerQueriesCollector=$timerQueriesCollector, databaseCollector=$databaseCollector]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostIntegrationConfigResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostIntegrationConfigResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostIntegrationConfigResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PostIntegrationConfigResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PostIntegrationConfigResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
