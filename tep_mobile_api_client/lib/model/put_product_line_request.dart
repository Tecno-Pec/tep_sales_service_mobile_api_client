...
class PutProductLineRequest {
  /// Returns a new [PutProductLineRequest] instance.
  ...
  /// Returns a new [PutProductLineRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PutProductLineRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PutProductLineRequest> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PutProductLineRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PutProductLineRequest> mapFromJson(dynamic json) {
    final map = <String, PutProductLineRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PutProductLineRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
