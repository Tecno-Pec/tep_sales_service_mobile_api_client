...
class GetAllVehicleTypeResponse {
  /// Returns a new [GetAllVehicleTypeResponse] instance.
  ...
  /// Returns a new [GetAllVehicleTypeResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllVehicleTypeResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GetAllVehicleTypeResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllVehicleTypeResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetAllVehicleTypeResponse> mapFromJson(dynamic json) {
    final map = <String, GetAllVehicleTypeResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetAllVehicleTypeResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
