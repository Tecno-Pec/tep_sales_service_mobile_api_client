...
class GetAllAddressResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetAllAddressResponse &&
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetAllAddressResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetAllAddressResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetAllAddressResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<GetAllAddressResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetAllAddressResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
