...
class PutPriceTableRequest {
  ...
  @override
  String toString() =>
      'PutPriceTableRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, name=$name, operationType=$operationType, description=$description, externalCode=$externalCode, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PutPriceTableRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PutPriceTableRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PutPriceTableRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PutPriceTableRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PutPriceTableRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
