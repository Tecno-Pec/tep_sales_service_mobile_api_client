...
class GetAllPagedPaymentPriceTableResponse {
  /// Returns a new [GetAllPagedPaymentPriceTableResponse] instance.
  ...
  /// Returns a new [GetAllPagedPaymentPriceTableResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllPagedPaymentPriceTableResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetAllPagedPaymentPriceTableResponse(
        ...
        results: GetAllPaymentPriceTableResponse.listFromJson(json[r'results']),
      );
    }
    return null;
  }
  ...
  static List<GetAllPagedPaymentPriceTableResponse> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllPagedPaymentPriceTableResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
