...
class PostClientResponse {
  ...
  @override
  String toString() =>
      'PostClientResponse[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, name=$name, document=$document, phone=$phone, ie=$ie, email=$email, externalCode=$externalCode, status=$status, userSellerId=$userSellerId, paymentConditionId=$paymentConditionId]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostClientResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostClientResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostClientResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PostClientResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PostClientResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
