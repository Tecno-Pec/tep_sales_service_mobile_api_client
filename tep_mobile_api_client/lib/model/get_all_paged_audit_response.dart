...
class GetAllPagedAuditResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetAllPagedAuditResponse &&
  ...
  @override
  String toString() => 'GetAllPagedAuditResponse[currentPage=$currentPage, pageCount=$pageCount, pageSize=$pageSize, rowCount=$rowCount, firstRowOnPage=$firstRowOnPage, lastRowOnPage=$lastRowOnPage, results=$results]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetAllPagedAuditResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetAllPagedAuditResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetAllPagedAuditResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GetAllPagedAuditResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetAllPagedAuditResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetAllPagedAuditResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
