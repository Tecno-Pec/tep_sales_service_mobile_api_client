...
class GetAllPaymentPriceTableResponse {
  /// Returns a new [GetAllPaymentPriceTableResponse] instance.
  ...
  /// Returns a new [GetAllPaymentPriceTableResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAllPaymentPriceTableResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetAllPaymentPriceTableResponse(
  ...
  static List<GetAllPaymentPriceTableResponse> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAllPaymentPriceTableResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetAllPaymentPriceTableResponse> mapFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = GetAllPaymentPriceTableResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
