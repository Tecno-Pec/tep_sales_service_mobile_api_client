...
class PostUserResetPassword {
  /// Returns a new [PostUserResetPassword] instance.
  ...
  /// Returns a new [PostUserResetPassword] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostUserResetPassword? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PostUserResetPassword> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostUserResetPassword.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostUserResetPassword> mapFromJson(dynamic json) {
    final map = <String, PostUserResetPassword>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostUserResetPassword.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
