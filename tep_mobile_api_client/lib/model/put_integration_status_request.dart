...
class PutIntegrationStatusRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PutIntegrationStatusRequest &&
  ...
  @override
  String toString() => 'PutIntegrationStatusRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, context=$context, action=$action, status=$status, summary=$summary, date=$date, quantityEntities=$quantityEntities]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PutIntegrationStatusRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PutIntegrationStatusRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PutIntegrationStatusRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PutIntegrationStatusRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PutIntegrationStatusRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PutIntegrationStatusRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
