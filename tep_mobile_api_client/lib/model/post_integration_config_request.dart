...
class PostIntegrationConfigRequest {
  /// Returns a new [PostIntegrationConfigRequest] instance.
  ...
  /// Returns a new [PostIntegrationConfigRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PostIntegrationConfigRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PostIntegrationConfigRequest(
  ...
  static List<PostIntegrationConfigRequest> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostIntegrationConfigRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostIntegrationConfigRequest> mapFromJson(dynamic json) {
    final map = <String, PostIntegrationConfigRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostIntegrationConfigRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
