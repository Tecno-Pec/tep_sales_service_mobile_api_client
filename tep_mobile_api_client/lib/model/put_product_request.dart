...
class PutProductRequest {
  /// Returns a new [PutProductRequest] instance.
  PutProductRequest({
    this.createdAt,
    this.updatedAt,
    this.userCreated,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PutProductRequest &&
  ...
  /// Returns a new [PutProductRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PutProductRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PutProductRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PutProductRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PutProductRequest(
  ...
  static List<PutProductRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PutProductRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PutProductRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PutProductRequest> mapFromJson(dynamic json) {
    final map = <String, PutProductRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PutProductRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PutProductRequest-objects as value to a dart map
  static Map<String, List<PutProductRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PutProductRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PutProductRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
