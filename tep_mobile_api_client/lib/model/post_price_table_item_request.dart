...
class PostPriceTableItemRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is PostPriceTableItemRequest &&
  ...
  @override
  String toString() =>
      'PostPriceTableItemRequest[createdAt=$createdAt, updatedAt=$updatedAt, userCreated=$userCreated, userUpdated=$userUpdated, id=$id, paymentPriceTableId=$paymentPriceTableId, productId=$productId, value=$value, externalCode=$externalCode, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostPriceTableItemRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostPriceTableItemRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostPriceTableItemRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PostPriceTableItemRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PostPriceTableItemRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
