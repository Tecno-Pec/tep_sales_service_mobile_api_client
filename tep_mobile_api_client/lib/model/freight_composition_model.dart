...
class FreightCompositionModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FreightCompositionModel &&
  ...
  @override
  String toString() => 'FreightCompositionModel[vehicleTypeId=$vehicleTypeId, weight=$weight, value=$value]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FreightCompositionModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FreightCompositionModel[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FreightCompositionModel> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<FreightCompositionModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FreightCompositionModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FreightCompositionModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
