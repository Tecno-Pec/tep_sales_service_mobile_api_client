...
class PutCompanyGlobalParameterRequest {
  /// Returns a new [PutCompanyGlobalParameterRequest] instance.
  ...
  /// Returns a new [PutCompanyGlobalParameterRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PutCompanyGlobalParameterRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PutCompanyGlobalParameterRequest(
  ...
  static List<PutCompanyGlobalParameterRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PutCompanyGlobalParameterRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PutCompanyGlobalParameterRequest> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = PutCompanyGlobalParameterRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
