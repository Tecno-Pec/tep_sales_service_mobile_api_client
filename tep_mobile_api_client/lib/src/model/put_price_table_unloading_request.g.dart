...
class _$PutPriceTableUnloadingRequest extends PutPriceTableUnloadingRequest {
  ...
  factory _$PutPriceTableUnloadingRequest(
      ...
      (new PutPriceTableUnloadingRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PutPriceTableUnloadingRequest')
...
class PutPriceTableUnloadingRequestBuilder
  ...
  @override
  _$PutPriceTableUnloadingRequest build() {
    final _$result = _$v ??
