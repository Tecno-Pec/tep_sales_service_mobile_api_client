...
class _$PutCommissionRequest extends PutCommissionRequest {
  ...
  factory _$PutCommissionRequest(
      ...
      (new PutCommissionRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutCommissionRequest')
...
class PutCommissionRequestBuilder
  ...
  @override
  PutCommissionRequest build() => _build();

  _$PutCommissionRequest _build() {
    final _$result = _$v ??
