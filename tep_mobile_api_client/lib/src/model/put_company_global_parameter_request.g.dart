...
class _$PutCompanyGlobalParameterRequest
  ...
  factory _$PutCompanyGlobalParameterRequest(
      ...
      (new PutCompanyGlobalParameterRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PutCompanyGlobalParameterRequest')
...
class PutCompanyGlobalParameterRequestBuilder
  ...
  @override
  _$PutCompanyGlobalParameterRequest build() {
    final _$result = _$v ??
