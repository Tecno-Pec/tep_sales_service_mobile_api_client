...
class _$PutPurchaseOrderRequest extends PutPurchaseOrderRequest {
  ...
  factory _$PutPurchaseOrderRequest(
      ...
      (new PutPurchaseOrderRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutPurchaseOrderRequest')
...
class PutPurchaseOrderRequestBuilder
  ...
  @override
  PutPurchaseOrderRequest build() => _build();

  _$PutPurchaseOrderRequest _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PutPurchaseOrderRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
