...
class _$PostPriceTableUnloadingResponse
  ...
  factory _$PostPriceTableUnloadingResponse(
      ...
      (new PostPriceTableUnloadingResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostPriceTableUnloadingResponse')
...
class PostPriceTableUnloadingResponseBuilder
  ...
  @override
  _$PostPriceTableUnloadingResponse build() {
    final _$result = _$v ??
