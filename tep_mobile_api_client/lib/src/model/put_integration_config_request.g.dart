...
class _$PutIntegrationConfigRequest extends PutIntegrationConfigRequest {
  ...
  factory _$PutIntegrationConfigRequest(
      ...
      (new PutIntegrationConfigRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutIntegrationConfigRequest')
...
class PutIntegrationConfigRequestBuilder
  ...
  @override
  PutIntegrationConfigRequest build() => _build();

  _$PutIntegrationConfigRequest _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PutIntegrationConfigRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
