...
class _$PostProductLineRequest extends PostProductLineRequest {
  ...
  factory _$PostProductLineRequest(
      ...
      (new PostProductLineRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostProductLineRequest')
...
class PostProductLineRequestBuilder
  ...
  @override
  PostProductLineRequest build() => _build();

  _$PostProductLineRequest _build() {
    final _$result = _$v ??
