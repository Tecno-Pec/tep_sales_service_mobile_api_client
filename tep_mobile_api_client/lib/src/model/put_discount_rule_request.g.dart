...
class _$PutDiscountRuleRequest extends PutDiscountRuleRequest {
  ...
  factory _$PutDiscountRuleRequest(
      ...
      (new PutDiscountRuleRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutDiscountRuleRequest')
...
class PutDiscountRuleRequestBuilder
  ...
  @override
  PutDiscountRuleRequest build() => _build();

  _$PutDiscountRuleRequest _build() {
    final _$result = _$v ??
