...
class _$GetAllFreightConversionFactorResponseSerializer implements StructuredSerializer<GetAllFreightConversionFactorResponse> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllFreightConversionFactorResponse object,
    ...
    @override
    GetAllFreightConversionFactorResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
