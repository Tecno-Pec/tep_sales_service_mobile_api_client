...
class _$GetAllVehicleTypeResponse extends GetAllVehicleTypeResponse {
  ...
  factory _$GetAllVehicleTypeResponse(
      ...
      (new GetAllVehicleTypeResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllVehicleTypeResponse')
...
class GetAllVehicleTypeResponseBuilder
  ...
  @override
  GetAllVehicleTypeResponse build() => _build();

  _$GetAllVehicleTypeResponse _build() {
    final _$result = _$v ??
