...
part of 'post_discount_rule_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PostDiscountRuleResponse extends PostDiscountRuleResponse {
  @override
  ...
  factory _$PostDiscountRuleResponse(
          [void Function(PostDiscountRuleResponseBuilder)? updates]) =>
      (new PostDiscountRuleResponseBuilder()..update(updates))._build();

  _$PostDiscountRuleResponse._(
      {this.createdAt,
      this.updatedAt,
      this.userCreated,
      this.userUpdated,
  ...
  @override
  PostDiscountRuleResponse rebuild(
          void Function(PostDiscountRuleResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PostDiscountRuleResponseBuilder toBuilder() =>
      new PostDiscountRuleResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PostDiscountRuleResponse &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostDiscountRuleResponse')
...
class PostDiscountRuleResponseBuilder
    implements
        Builder<PostDiscountRuleResponse, PostDiscountRuleResponseBuilder> {
  _$PostDiscountRuleResponse? _$v;
  ...
  PostDiscountRuleResponseBuilder() {
    PostDiscountRuleResponse._defaults(this);
  }

  PostDiscountRuleResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PostDiscountRuleResponse other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PostDiscountRuleResponse;
  }

  @override
  void update(void Function(PostDiscountRuleResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PostDiscountRuleResponse build() => _build();

  _$PostDiscountRuleResponse _build() {
    final _$result = _$v ??
        new _$PostDiscountRuleResponse._(
            createdAt: createdAt,
            updatedAt: updatedAt,
