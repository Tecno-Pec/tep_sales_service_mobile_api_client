...
part 'get_all_freight_table_response.g.dart';
...
/// * [operationType] 
/// * [status] 
abstract class GetAllFreightTableResponse implements Built<GetAllFreightTableResponse, GetAllFreightTableResponseBuilder> {
    ...
    GetAllFreightTableResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(GetAllFreightTableResponseBuilder b) => b;

    factory GetAllFreightTableResponse([void updates(GetAllFreightTableResponseBuilder b)]) = _$GetAllFreightTableResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<GetAllFreightTableResponse> get serializer => _$GetAllFreightTableResponseSerializer();
}

class _$GetAllFreightTableResponseSerializer implements StructuredSerializer<GetAllFreightTableResponse> {
    @override
    final Iterable<Type> types = const [GetAllFreightTableResponse, _$GetAllFreightTableResponse];

    @override
    final String wireName = r'GetAllFreightTableResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllFreightTableResponse object,
    ...
    @override
    GetAllFreightTableResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = GetAllFreightTableResponseBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'status':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(FreightTableStatus)) as FreightTableStatus;
