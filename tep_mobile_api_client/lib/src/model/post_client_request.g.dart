...
class _$PostClientRequest extends PostClientRequest {
  ...
  factory _$PostClientRequest(
      ...
      (new PostClientRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostClientRequest')
...
class PostClientRequestBuilder
  ...
  @override
  PostClientRequest build() => _build();

  _$PostClientRequest _build() {
    final _$result = _$v ??
