...
part of 'post_discount_rule_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PostDiscountRuleRequest extends PostDiscountRuleRequest {
  @override
  ...
  factory _$PostDiscountRuleRequest(
          [void Function(PostDiscountRuleRequestBuilder)? updates]) =>
      (new PostDiscountRuleRequestBuilder()..update(updates))._build();

  _$PostDiscountRuleRequest._(
      {this.createdAt,
      this.updatedAt,
      this.userCreated,
      this.userUpdated,
  ...
  @override
  PostDiscountRuleRequest rebuild(
          void Function(PostDiscountRuleRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PostDiscountRuleRequestBuilder toBuilder() =>
      new PostDiscountRuleRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PostDiscountRuleRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostDiscountRuleRequest')
...
class PostDiscountRuleRequestBuilder
    implements
        Builder<PostDiscountRuleRequest, PostDiscountRuleRequestBuilder> {
  _$PostDiscountRuleRequest? _$v;
  ...
  PostDiscountRuleRequestBuilder() {
    PostDiscountRuleRequest._defaults(this);
  }

  PostDiscountRuleRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PostDiscountRuleRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PostDiscountRuleRequest;
  }

  @override
  void update(void Function(PostDiscountRuleRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PostDiscountRuleRequest build() => _build();

  _$PostDiscountRuleRequest _build() {
    final _$result = _$v ??
        new _$PostDiscountRuleRequest._(
            createdAt: createdAt,
            updatedAt: updatedAt,
