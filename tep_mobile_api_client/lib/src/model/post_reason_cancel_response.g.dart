...
class _$PostReasonCancelResponse extends PostReasonCancelResponse {
  ...
  factory _$PostReasonCancelResponse(
      ...
      (new PostReasonCancelResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostReasonCancelResponse')
...
class PostReasonCancelResponseBuilder
  ...
  @override
  PostReasonCancelResponse build() => _build();

  _$PostReasonCancelResponse _build() {
    final _$result = _$v ??
