...
class _$PostDistribuitionCenterRequest extends PostDistribuitionCenterRequest {
  ...
  factory _$PostDistribuitionCenterRequest(
      ...
      (new PostDistribuitionCenterRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostDistribuitionCenterRequest')
...
class PostDistribuitionCenterRequestBuilder
  ...
  @override
  PostDistribuitionCenterRequest build() => _build();

  _$PostDistribuitionCenterRequest _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PostDistribuitionCenterRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
