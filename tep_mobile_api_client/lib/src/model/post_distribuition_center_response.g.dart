...
class _$PostDistribuitionCenterResponse
  ...
  factory _$PostDistribuitionCenterResponse(
      ...
      (new PostDistribuitionCenterResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostDistribuitionCenterResponse')
...
class PostDistribuitionCenterResponseBuilder
  ...
  @override
  _$PostDistribuitionCenterResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'PostDistribuitionCenterResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
