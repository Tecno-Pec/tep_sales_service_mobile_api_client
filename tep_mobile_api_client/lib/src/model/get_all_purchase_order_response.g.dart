...
class _$GetAllPurchaseOrderResponse extends GetAllPurchaseOrderResponse {
  ...
  factory _$GetAllPurchaseOrderResponse(
      ...
      (new GetAllPurchaseOrderResponseBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            ...
            reasonCancel.hashCode),
        status.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllPurchaseOrderResponse')
...
class GetAllPurchaseOrderResponseBuilder
  ...
  @override
  _$GetAllPurchaseOrderResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllPurchaseOrderResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
