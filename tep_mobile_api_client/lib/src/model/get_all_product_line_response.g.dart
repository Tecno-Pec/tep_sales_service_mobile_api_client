...
class _$GetAllProductLineResponse extends GetAllProductLineResponse {
  ...
  factory _$GetAllProductLineResponse(
      ...
      (new GetAllProductLineResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllProductLineResponse')
...
class GetAllProductLineResponseBuilder
  ...
  @override
  _$GetAllProductLineResponse build() {
    final _$result = _$v ??
