...
class _$PutIntegrationStatusRequest extends PutIntegrationStatusRequest {
  ...
  factory _$PutIntegrationStatusRequest(
      ...
      (new PutIntegrationStatusRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PutIntegrationStatusRequest')
...
class PutIntegrationStatusRequestBuilder
  ...
  @override
  _$PutIntegrationStatusRequest build() {
    final _$result = _$v ??
