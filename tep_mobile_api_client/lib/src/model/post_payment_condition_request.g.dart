...
class _$PostPaymentConditionRequest extends PostPaymentConditionRequest {
  ...
  factory _$PostPaymentConditionRequest(
      ...
      (new PostPaymentConditionRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostPaymentConditionRequest')
...
class PostPaymentConditionRequestBuilder
  ...
  @override
  PostPaymentConditionRequest build() => _build();

  _$PostPaymentConditionRequest _build() {
    final _$result = _$v ??
