...
class _$PostPriceTableUnloadingRequest extends PostPriceTableUnloadingRequest {
  ...
  factory _$PostPriceTableUnloadingRequest(
      ...
      (new PostPriceTableUnloadingRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostPriceTableUnloadingRequest')
...
class PostPriceTableUnloadingRequestBuilder
  ...
  @override
  PostPriceTableUnloadingRequest build() => _build();

  _$PostPriceTableUnloadingRequest _build() {
    final _$result = _$v ??
