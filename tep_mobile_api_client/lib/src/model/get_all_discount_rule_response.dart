...
part 'get_all_discount_rule_response.g.dart';
...
/// * [externalCode] 
/// * [status] 
abstract class GetAllDiscountRuleResponse implements Built<GetAllDiscountRuleResponse, GetAllDiscountRuleResponseBuilder> {
    ...
    GetAllDiscountRuleResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(GetAllDiscountRuleResponseBuilder b) => b;

    factory GetAllDiscountRuleResponse([void updates(GetAllDiscountRuleResponseBuilder b)]) = _$GetAllDiscountRuleResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<GetAllDiscountRuleResponse> get serializer => _$GetAllDiscountRuleResponseSerializer();
}

class _$GetAllDiscountRuleResponseSerializer implements StructuredSerializer<GetAllDiscountRuleResponse> {
    @override
    final Iterable<Type> types = const [GetAllDiscountRuleResponse, _$GetAllDiscountRuleResponse];

    @override
    final String wireName = r'GetAllDiscountRuleResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllDiscountRuleResponse object,
    ...
    @override
    GetAllDiscountRuleResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = GetAllDiscountRuleResponseBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'status':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(DiscountRuleStatus)) as DiscountRuleStatus;
