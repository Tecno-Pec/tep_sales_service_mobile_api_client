...
class _$PostCommissionRequest extends PostCommissionRequest {
  ...
  factory _$PostCommissionRequest(
      ...
      (new PostCommissionRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostCommissionRequest')
...
class PostCommissionRequestBuilder
  ...
  @override
  PostCommissionRequest build() => _build();

  _$PostCommissionRequest _build() {
    final _$result = _$v ??
