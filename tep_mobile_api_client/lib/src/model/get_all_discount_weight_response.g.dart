...
class _$GetAllDiscountWeightResponse extends GetAllDiscountWeightResponse {
  ...
  factory _$GetAllDiscountWeightResponse(
      ...
      (new GetAllDiscountWeightResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllDiscountWeightResponse')
...
class GetAllDiscountWeightResponseBuilder
  ...
  @override
  _$GetAllDiscountWeightResponse build() {
    final _$result = _$v ??
