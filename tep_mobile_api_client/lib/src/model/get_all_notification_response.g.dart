...
class _$GetAllNotificationResponse extends GetAllNotificationResponse {
  ...
  factory _$GetAllNotificationResponse(
      ...
      (new GetAllNotificationResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllNotificationResponse')
...
class GetAllNotificationResponseBuilder
  ...
  @override
  GetAllNotificationResponse build() => _build();

  _$GetAllNotificationResponse _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GetAllNotificationResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
