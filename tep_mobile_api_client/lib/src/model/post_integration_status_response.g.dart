...
class _$PostIntegrationStatusResponse extends PostIntegrationStatusResponse {
  ...
  factory _$PostIntegrationStatusResponse(
      ...
      (new PostIntegrationStatusResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostIntegrationStatusResponse')
...
class PostIntegrationStatusResponseBuilder
  ...
  @override
  _$PostIntegrationStatusResponse build() {
    final _$result = _$v ??
