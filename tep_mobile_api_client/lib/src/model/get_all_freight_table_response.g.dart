...
part of 'get_all_freight_table_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$GetAllFreightTableResponse extends GetAllFreightTableResponse {
  @override
  ...
  factory _$GetAllFreightTableResponse(
          [void Function(GetAllFreightTableResponseBuilder)? updates]) =>
      (new GetAllFreightTableResponseBuilder()..update(updates))._build();

  _$GetAllFreightTableResponse._(
      {this.createdAt,
      this.updatedAt,
      this.userCreated,
      this.userUpdated,
  ...
  @override
  GetAllFreightTableResponse rebuild(
          void Function(GetAllFreightTableResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GetAllFreightTableResponseBuilder toBuilder() =>
      new GetAllFreightTableResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetAllFreightTableResponse &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllFreightTableResponse')
...
class GetAllFreightTableResponseBuilder
    implements
        Builder<GetAllFreightTableResponse, GetAllFreightTableResponseBuilder> {
  _$GetAllFreightTableResponse? _$v;
  ...
  GetAllFreightTableResponseBuilder() {
    GetAllFreightTableResponse._defaults(this);
  }

  GetAllFreightTableResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(GetAllFreightTableResponse other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GetAllFreightTableResponse;
  }

  @override
  void update(void Function(GetAllFreightTableResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GetAllFreightTableResponse build() => _build();

  _$GetAllFreightTableResponse _build() {
    final _$result = _$v ??
        new _$GetAllFreightTableResponse._(
            createdAt: createdAt,
            updatedAt: updatedAt,
