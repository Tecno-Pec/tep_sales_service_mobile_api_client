...
class _$PostProductRequest extends PostProductRequest {
  ...
  factory _$PostProductRequest(
      ...
      (new PostProductRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostProductRequest')
...
class PostProductRequestBuilder
  ...
  @override
  PostProductRequest build() => _build();

  _$PostProductRequest _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PostProductRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
