...
part of 'post_freight_table_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PostFreightTableRequest extends PostFreightTableRequest {
  @override
  ...
  factory _$PostFreightTableRequest(
          [void Function(PostFreightTableRequestBuilder)? updates]) =>
      (new PostFreightTableRequestBuilder()..update(updates))._build();

  _$PostFreightTableRequest._(
      {this.createdAt,
      this.updatedAt,
      this.userCreated,
      this.userUpdated,
  ...
  @override
  PostFreightTableRequest rebuild(
          void Function(PostFreightTableRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PostFreightTableRequestBuilder toBuilder() =>
      new PostFreightTableRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PostFreightTableRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostFreightTableRequest')
...
class PostFreightTableRequestBuilder
    implements
        Builder<PostFreightTableRequest, PostFreightTableRequestBuilder> {
  _$PostFreightTableRequest? _$v;
  ...
  PostFreightTableRequestBuilder() {
    PostFreightTableRequest._defaults(this);
  }

  PostFreightTableRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PostFreightTableRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PostFreightTableRequest;
  }

  @override
  void update(void Function(PostFreightTableRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PostFreightTableRequest build() => _build();

  _$PostFreightTableRequest _build() {
    final _$result = _$v ??
        new _$PostFreightTableRequest._(
            createdAt: createdAt,
            updatedAt: updatedAt,
