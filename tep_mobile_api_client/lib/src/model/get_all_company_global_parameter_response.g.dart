...
class _$GetAllCompanyGlobalParameterResponse
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllCompanyGlobalParameterResponse')
...
class GetAllCompanyGlobalParameterResponseBuilder
  ...
  @override
  GetAllCompanyGlobalParameterResponse build() => _build();

  _$GetAllCompanyGlobalParameterResponse _build() {
    final _$result = _$v ??
