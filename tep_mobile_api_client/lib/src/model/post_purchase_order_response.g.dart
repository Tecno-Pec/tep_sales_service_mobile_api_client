...
class _$PostPurchaseOrderResponse extends PostPurchaseOrderResponse {
  ...
  factory _$PostPurchaseOrderResponse(
      ...
      (new PostPurchaseOrderResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostPurchaseOrderResponse')
...
class PostPurchaseOrderResponseBuilder
  ...
  @override
  PostPurchaseOrderResponse build() => _build();

  _$PostPurchaseOrderResponse _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PostPurchaseOrderResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
