...
part 'put_discount_rule_request.g.dart';
...
/// * [externalCode] 
/// * [status] 
abstract class PutDiscountRuleRequest implements Built<PutDiscountRuleRequest, PutDiscountRuleRequestBuilder> {
    ...
    PutDiscountRuleRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PutDiscountRuleRequestBuilder b) => b;

    factory PutDiscountRuleRequest([void updates(PutDiscountRuleRequestBuilder b)]) = _$PutDiscountRuleRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<PutDiscountRuleRequest> get serializer => _$PutDiscountRuleRequestSerializer();
}

class _$PutDiscountRuleRequestSerializer implements StructuredSerializer<PutDiscountRuleRequest> {
    @override
    final Iterable<Type> types = const [PutDiscountRuleRequest, _$PutDiscountRuleRequest];

    @override
    final String wireName = r'PutDiscountRuleRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, PutDiscountRuleRequest object,
    ...
    @override
    PutDiscountRuleRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PutDiscountRuleRequestBuilder();
