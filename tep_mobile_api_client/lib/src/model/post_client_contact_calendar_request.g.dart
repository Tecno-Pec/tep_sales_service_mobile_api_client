...
part of 'post_client_contact_calendar_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PostClientContactCalendarRequest
    extends PostClientContactCalendarRequest {
  @override
  ...
  factory _$PostClientContactCalendarRequest(
          [void Function(PostClientContactCalendarRequestBuilder)? updates]) =>
      (new PostClientContactCalendarRequestBuilder()..update(updates))._build();

  _$PostClientContactCalendarRequest._(
      {this.createdAt,
      this.updatedAt,
      this.userCreated,
      this.userUpdated,
  ...
  @override
  PostClientContactCalendarRequest rebuild(
          void Function(PostClientContactCalendarRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PostClientContactCalendarRequestBuilder toBuilder() =>
      new PostClientContactCalendarRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PostClientContactCalendarRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostClientContactCalendarRequest')
...
class PostClientContactCalendarRequestBuilder
    implements
        Builder<PostClientContactCalendarRequest,
            PostClientContactCalendarRequestBuilder> {
  _$PostClientContactCalendarRequest? _$v;
  ...
  PostClientContactCalendarRequestBuilder() {
    PostClientContactCalendarRequest._defaults(this);
  }

  PostClientContactCalendarRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PostClientContactCalendarRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PostClientContactCalendarRequest;
  }

  @override
  void update(void Function(PostClientContactCalendarRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PostClientContactCalendarRequest build() => _build();

  _$PostClientContactCalendarRequest _build() {
    _$PostClientContactCalendarRequest _$result;
    try {
      _$result = _$v ??
          new _$PostClientContactCalendarRequest._(
              createdAt: createdAt,
              updatedAt: updatedAt,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PostClientContactCalendarRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
