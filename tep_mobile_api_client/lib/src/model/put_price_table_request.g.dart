...
class _$PutPriceTableRequest extends PutPriceTableRequest {
  ...
  factory _$PutPriceTableRequest(
      ...
      (new PutPriceTableRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutPriceTableRequest')
...
class PutPriceTableRequestBuilder
  ...
  @override
  PutPriceTableRequest build() => _build();

  _$PutPriceTableRequest _build() {
    final _$result = _$v ??
