...
class _$PutProductLineRequest extends PutProductLineRequest {
  ...
  factory _$PutProductLineRequest(
      ...
      (new PutProductLineRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutProductLineRequest')
...
class PutProductLineRequestBuilder
  ...
  @override
  PutProductLineRequest build() => _build();

  _$PutProductLineRequest _build() {
    final _$result = _$v ??
