...
class _$GetAllPagedIntegrationConfigResponseSerializer implements StructuredSerializer<GetAllPagedIntegrationConfigResponse> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllPagedIntegrationConfigResponse object,
    ...
    @override
    GetAllPagedIntegrationConfigResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllIntegrationConfigResponse)])) as BuiltList<GetAllIntegrationConfigResponse>?;
