...
class _$PutPaymentConditionRequest extends PutPaymentConditionRequest {
  ...
  factory _$PutPaymentConditionRequest(
      ...
      (new PutPaymentConditionRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutPaymentConditionRequest')
...
class PutPaymentConditionRequestBuilder
  ...
  @override
  PutPaymentConditionRequest build() => _build();

  _$PutPaymentConditionRequest _build() {
    final _$result = _$v ??
