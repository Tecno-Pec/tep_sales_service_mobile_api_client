...
/// * [externalCode] 
/// * [status] 
abstract class PostAddressRequest implements Built<PostAddressRequest, PostAddressRequestBuilder> {
    ...
    PostAddressRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PostAddressRequestBuilder b) => b;

    factory PostAddressRequest([void updates(PostAddressRequestBuilder b)]) = _$PostAddressRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<PostAddressRequest> get serializer => _$PostAddressRequestSerializer();
}

class _$PostAddressRequestSerializer implements StructuredSerializer<PostAddressRequest> {
    @override
    final Iterable<Type> types = const [PostAddressRequest, _$PostAddressRequest];

    @override
    final String wireName = r'PostAddressRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, PostAddressRequest object,
    ...
    @override
    PostAddressRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PostAddressRequestBuilder();
