...
class _$PostPurchaseOrderRequest extends PostPurchaseOrderRequest {
  ...
  factory _$PostPurchaseOrderRequest(
      ...
      (new PostPurchaseOrderRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostPurchaseOrderRequest')
...
class PostPurchaseOrderRequestBuilder
  ...
  @override
  _$PostPurchaseOrderRequest build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'PostPurchaseOrderRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
