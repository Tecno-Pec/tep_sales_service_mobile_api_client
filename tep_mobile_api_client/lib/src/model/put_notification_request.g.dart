...
class _$PutNotificationRequest extends PutNotificationRequest {
  ...
  factory _$PutNotificationRequest(
      ...
      (new PutNotificationRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutNotificationRequest')
...
class PutNotificationRequestBuilder
  ...
  @override
  PutNotificationRequest build() => _build();

  _$PutNotificationRequest _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PutNotificationRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
