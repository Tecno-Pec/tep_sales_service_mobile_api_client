...
class _$GetAllPagedIntegrationStatusResponse
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllPagedIntegrationStatusResponse')
...
class GetAllPagedIntegrationStatusResponseBuilder
  ...
  @override
  GetAllPagedIntegrationStatusResponse build() => _build();

  _$GetAllPagedIntegrationStatusResponse _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GetAllPagedIntegrationStatusResponse',
            _$failedField,
            e.toString());
      }
      rethrow;
