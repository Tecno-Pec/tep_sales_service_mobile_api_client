...
class _$GetAllPagedPriceTableUnloadingResponseSerializer implements StructuredSerializer<GetAllPagedPriceTableUnloadingResponse> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllPagedPriceTableUnloadingResponse object,
    ...
    @override
    GetAllPagedPriceTableUnloadingResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllPriceTableUnloadingResponse)])) as BuiltList<GetAllPriceTableUnloadingResponse>?;
