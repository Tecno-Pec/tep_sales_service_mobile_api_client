...
part of 'put_freight_table_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PutFreightTableRequest extends PutFreightTableRequest {
  @override
  ...
  factory _$PutFreightTableRequest(
          [void Function(PutFreightTableRequestBuilder)? updates]) =>
      (new PutFreightTableRequestBuilder()..update(updates))._build();

  _$PutFreightTableRequest._(
      {this.createdAt,
      this.updatedAt,
      this.userCreated,
      this.userUpdated,
  ...
  @override
  PutFreightTableRequest rebuild(
          void Function(PutFreightTableRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PutFreightTableRequestBuilder toBuilder() =>
      new PutFreightTableRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PutFreightTableRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutFreightTableRequest')
...
class PutFreightTableRequestBuilder
    implements Builder<PutFreightTableRequest, PutFreightTableRequestBuilder> {
  _$PutFreightTableRequest? _$v;
  ...
  PutFreightTableRequestBuilder() {
    PutFreightTableRequest._defaults(this);
  }

  PutFreightTableRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PutFreightTableRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PutFreightTableRequest;
  }

  @override
  void update(void Function(PutFreightTableRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PutFreightTableRequest build() => _build();

  _$PutFreightTableRequest _build() {
    final _$result = _$v ??
        new _$PutFreightTableRequest._(
            createdAt: createdAt,
            updatedAt: updatedAt,
