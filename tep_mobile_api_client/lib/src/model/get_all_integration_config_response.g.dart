...
class _$GetAllIntegrationConfigResponse
  ...
  factory _$GetAllIntegrationConfigResponse(
      ...
      (new GetAllIntegrationConfigResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllIntegrationConfigResponse')
...
class GetAllIntegrationConfigResponseBuilder
  ...
  @override
  _$GetAllIntegrationConfigResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllIntegrationConfigResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
