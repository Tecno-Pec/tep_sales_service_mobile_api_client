...
class _$PostClientResponse extends PostClientResponse {
  ...
  factory _$PostClientResponse(
      ...
      (new PostClientResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostClientResponse')
...
class PostClientResponseBuilder
  ...
  @override
  PostClientResponse build() => _build();

  _$PostClientResponse _build() {
    final _$result = _$v ??
