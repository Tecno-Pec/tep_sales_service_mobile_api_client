...
class _$GetAllCompanyResponse extends GetAllCompanyResponse {
  ...
  factory _$GetAllCompanyResponse(
      ...
      (new GetAllCompanyResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllCompanyResponse')
...
class GetAllCompanyResponseBuilder
  ...
  @override
  GetAllCompanyResponse build() => _build();

  _$GetAllCompanyResponse _build() {
    final _$result = _$v ??
