...
part 'post_discount_rule_request.g.dart';
...
/// * [externalCode] 
/// * [status] 
abstract class PostDiscountRuleRequest implements Built<PostDiscountRuleRequest, PostDiscountRuleRequestBuilder> {
    ...
    PostDiscountRuleRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PostDiscountRuleRequestBuilder b) => b;

    factory PostDiscountRuleRequest([void updates(PostDiscountRuleRequestBuilder b)]) = _$PostDiscountRuleRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<PostDiscountRuleRequest> get serializer => _$PostDiscountRuleRequestSerializer();
}

class _$PostDiscountRuleRequestSerializer implements StructuredSerializer<PostDiscountRuleRequest> {
    @override
    final Iterable<Type> types = const [PostDiscountRuleRequest, _$PostDiscountRuleRequest];

    @override
    final String wireName = r'PostDiscountRuleRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, PostDiscountRuleRequest object,
    ...
    @override
    PostDiscountRuleRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PostDiscountRuleRequestBuilder();
