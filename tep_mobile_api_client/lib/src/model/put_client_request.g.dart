...
class _$PutClientRequest extends PutClientRequest {
  ...
  factory _$PutClientRequest(
      ...
      (new PutClientRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutClientRequest')
...
class PutClientRequestBuilder
  ...
  @override
  PutClientRequest build() => _build();

  _$PutClientRequest _build() {
    final _$result = _$v ??
