...
class _$PutProductRequest extends PutProductRequest {
  ...
  factory _$PutProductRequest(
      ...
      (new PutProductRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutProductRequest')
...
class PutProductRequestBuilder
  ...
  @override
  PutProductRequest build() => _build();

  _$PutProductRequest _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PutProductRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
