...
class _$PostVehicleTypeRequest extends PostVehicleTypeRequest {
  ...
  factory _$PostVehicleTypeRequest(
      ...
      (new PostVehicleTypeRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostVehicleTypeRequest')
...
class PostVehicleTypeRequestBuilder
  ...
  @override
  PostVehicleTypeRequest build() => _build();

  _$PostVehicleTypeRequest _build() {
    final _$result = _$v ??
