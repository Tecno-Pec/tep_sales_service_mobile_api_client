...
class _$GetAllPagedDiscountWeightResponse
  ...
  factory _$GetAllPagedDiscountWeightResponse(
      ...
      (new GetAllPagedDiscountWeightResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllPagedDiscountWeightResponse')
...
class GetAllPagedDiscountWeightResponseBuilder
  ...
  @override
  _$GetAllPagedDiscountWeightResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllPagedDiscountWeightResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
