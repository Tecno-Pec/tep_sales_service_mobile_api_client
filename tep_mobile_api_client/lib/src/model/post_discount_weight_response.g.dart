...
class _$PostDiscountWeightResponse extends PostDiscountWeightResponse {
  ...
  factory _$PostDiscountWeightResponse(
      ...
      (new PostDiscountWeightResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostDiscountWeightResponse')
...
class PostDiscountWeightResponseBuilder
  ...
  @override
  PostDiscountWeightResponse build() => _build();

  _$PostDiscountWeightResponse _build() {
    final _$result = _$v ??
