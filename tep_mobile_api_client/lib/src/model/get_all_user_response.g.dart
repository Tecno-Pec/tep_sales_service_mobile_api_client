...
class _$GetAllUserResponse extends GetAllUserResponse {
  ...
  factory _$GetAllUserResponse(
      ...
      (new GetAllUserResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllUserResponse')
...
class GetAllUserResponseBuilder
  ...
  @override
  GetAllUserResponse build() => _build();

  _$GetAllUserResponse _build() {
    final _$result = _$v ??
