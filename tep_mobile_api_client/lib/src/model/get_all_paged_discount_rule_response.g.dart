...
class _$GetAllPagedDiscountRuleResponse
  ...
  factory _$GetAllPagedDiscountRuleResponse(
      ...
      (new GetAllPagedDiscountRuleResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllPagedDiscountRuleResponse')
...
class GetAllPagedDiscountRuleResponseBuilder
  ...
  @override
  _$GetAllPagedDiscountRuleResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllPagedDiscountRuleResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
