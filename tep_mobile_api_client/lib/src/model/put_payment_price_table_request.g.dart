...
class _$PutPaymentPriceTableRequest extends PutPaymentPriceTableRequest {
  ...
  factory _$PutPaymentPriceTableRequest(
      ...
      (new PutPaymentPriceTableRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PutPaymentPriceTableRequest')
...
class PutPaymentPriceTableRequestBuilder
  ...
  @override
  PutPaymentPriceTableRequest build() => _build();

  _$PutPaymentPriceTableRequest _build() {
    final _$result = _$v ??
