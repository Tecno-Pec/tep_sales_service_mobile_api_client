...
part 'put_price_table_unloading_request.g.dart';
...
/// * [valueOfKG] 
/// * [externalCode] 
abstract class PutPriceTableUnloadingRequest implements Built<PutPriceTableUnloadingRequest, PutPriceTableUnloadingRequestBuilder> {
    ...
    PutPriceTableUnloadingRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PutPriceTableUnloadingRequestBuilder b) => b;

    factory PutPriceTableUnloadingRequest([void updates(PutPriceTableUnloadingRequestBuilder b)]) = _$PutPriceTableUnloadingRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<PutPriceTableUnloadingRequest> get serializer => _$PutPriceTableUnloadingRequestSerializer();
}

class _$PutPriceTableUnloadingRequestSerializer implements StructuredSerializer<PutPriceTableUnloadingRequest> {
    @override
    final Iterable<Type> types = const [PutPriceTableUnloadingRequest, _$PutPriceTableUnloadingRequest];

    @override
    final String wireName = r'PutPriceTableUnloadingRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, PutPriceTableUnloadingRequest object,
    ...
    @override
    PutPriceTableUnloadingRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PutPriceTableUnloadingRequestBuilder();
