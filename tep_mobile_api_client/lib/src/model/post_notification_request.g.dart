...
class _$PostNotificationRequest extends PostNotificationRequest {
  ...
  factory _$PostNotificationRequest(
      ...
      (new PostNotificationRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostNotificationRequest')
...
class PostNotificationRequestBuilder
  ...
  @override
  PostNotificationRequest build() => _build();

  _$PostNotificationRequest _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PostNotificationRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
