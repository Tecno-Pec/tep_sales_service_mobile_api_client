...
class _$GetAllDiscountRuleResponse extends GetAllDiscountRuleResponse {
  ...
  factory _$GetAllDiscountRuleResponse(
      ...
      (new GetAllDiscountRuleResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllDiscountRuleResponse')
...
class GetAllDiscountRuleResponseBuilder
  ...
  @override
  _$GetAllDiscountRuleResponse build() {
    final _$result = _$v ??
