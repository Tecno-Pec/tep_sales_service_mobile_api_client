...
class _$PostPriceTableItemResponse extends PostPriceTableItemResponse {
  ...
  factory _$PostPriceTableItemResponse(
      ...
      (new PostPriceTableItemResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostPriceTableItemResponse')
...
class PostPriceTableItemResponseBuilder
  ...
  @override
  PostPriceTableItemResponse build() => _build();

  _$PostPriceTableItemResponse _build() {
    final _$result = _$v ??
