...
class _$PostCompanyRequest extends PostCompanyRequest {
  ...
  factory _$PostCompanyRequest(
      ...
      (new PostCompanyRequestBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PostCompanyRequest')
...
class PostCompanyRequestBuilder
  ...
  @override
  PostCompanyRequest build() => _build();

  _$PostCompanyRequest _build() {
    final _$result = _$v ??
