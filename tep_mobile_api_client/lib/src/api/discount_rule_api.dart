...
class DiscountRuleApi {
  ...
  Future<Response<GetAllDiscountRuleResponse>> getByIdDiscountRule({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '89cd7eb7-1ddd-4384-9f02-86c3cde7f5eb',
    ...
    try {
      const _responseType = FullType(GetAllDiscountRuleResponse);
  ...
  Future<Response<BuiltList<GetAllDiscountRuleResponse>>> tepsalesV1DiscountRulesAllGet({ 
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = '4385010e-9926-420e-9a50-83c5dbafe3b8',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _responseType = FullType(BuiltList, [FullType(GetAllDiscountRuleResponse)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<void>> tepsalesV1DiscountRulesIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'eefa141e-4d0c-4d1b-9393-738bf05826b8',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1DiscountRulesIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'd0e3eefb-7e25-41a3-b439-1674aee6cb4b',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1DiscountRulesIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'd23bd2bd-220f-4cdb-8fb7-a0a60beb5a36',
  ...
  Future<Response<GetAllPagedDiscountRuleResponse>> tepsalesV1DiscountRulesPagedGet({ 
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = '53e50777-6e70-4642-a78e-be7e3f001e84',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _responseType = FullType(GetAllPagedDiscountRuleResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<PostDiscountRuleResponse>> tepsalesV1DiscountRulesPost({ 
    String? xApiKey,
    String? xCsrfToken = '4280e0f0-a103-4002-a27d-0f0479a6fe62',
    ...
    try {
      const _responseType = FullType(PostDiscountRuleResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
