...
class ProductApi {
  ...
  Future<Response<GetAllProductResponse>> getByIdProduct({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'fcbf2451-0dd9-411b-93fc-822024b0bcee',
  ...
  Future<Response<BuiltList<GetAllProductResponse>>> tepsalesV1ProductsAllGet({ 
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = '77711b58-fe33-4c49-83b3-114d549f0f42',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1ProductsIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '8ae72d85-afa7-49b9-a1c8-64532e2044e1',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1ProductsIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '4b57245a-d972-47d8-acc9-5e00a9dbdc64',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1ProductsIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '3b20586f-aa97-4ea1-8a23-d29a6d096eee',
  ...
  Future<Response<GetAllPagedProductResponse>> tepsalesV1ProductsPagedGet({ 
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = '2c8b301d-3536-4817-aa97-33cc6b24da8d',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<PostProductResponse>> tepsalesV1ProductsPost({ 
    String? xApiKey,
    String? xCsrfToken = 'e9e820f7-c479-407a-9bdd-11dc33987521',
