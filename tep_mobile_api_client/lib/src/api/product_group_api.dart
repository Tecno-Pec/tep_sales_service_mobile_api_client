...
class ProductGroupApi {
  ...
  Future<Response<GetAllProductGroupResponse>> getByExternalCodeProductGroupController({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'b0336fad-df55-44eb-b3de-eb88632ff14d',
  ...
  Future<Response<GetAllProductGroupResponse>> getByIdProductGroup({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'd11b5fb3-8957-4bf5-bdae-0dca3581a2e5',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<BuiltList<GetAllProductGroupResponse>>> tepsalesV1ProductGroupsAllGet({ 
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = '09ddbc21-78b9-497e-91c9-9a461096d7b0',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1ProductGroupsIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '3fdc4ab3-ccd8-4ad1-85c6-b891966ef294',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1ProductGroupsIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'cd586030-594f-4d77-b434-4855863fd083',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1ProductGroupsIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'b364838d-568b-4821-8b3f-bf4c48bbb35a',
  ...
  Future<Response<GetAllPagedProductGroupResponse>> tepsalesV1ProductGroupsPagedGet({ 
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = 'babb2f60-f644-4d11-8893-7c68ba2df3d0',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<PostProductGroupResponse>> tepsalesV1ProductGroupsPost({ 
    String? xApiKey,
    String? xCsrfToken = 'bac74c47-dda6-438d-bf71-130a6bd371d6',
