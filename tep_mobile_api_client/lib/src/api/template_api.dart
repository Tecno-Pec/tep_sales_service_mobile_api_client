...
class TemplateApi {
  ...
  Future<Response<GetAllTemplateResponse>> getByIdTemplate({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'a3bf3855-b59f-4312-869e-e861b23b37ed',
    ...
    final _path = r'/tepsales/v1/templates/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllTemplateResponse),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GetAllTemplateResponse>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<GetAllTemplateResponse>>> tepsalesV1TemplatesAllGet({ 
    String? name,
    int? limit = 100,
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = 'c5a3e2d5-51cf-4c47-a0b7-ac02b3044f57',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/tepsales/v1/templates/all';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    BuiltList<GetAllTemplateResponse>? _responseData;
    ...
    try {
      ...
      ) as BuiltList<GetAllTemplateResponse>;
    ...
    return Response<BuiltList<GetAllTemplateResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tepsalesV1TemplatesIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '531c5120-95ea-4ac1-b42a-5552616bbf0f',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tepsalesV1TemplatesIdPatch({ 
    required String id,
    required BuiltList<Operation> operation,
    String? xApiKey,
    String? xCsrfToken = '75003fd6-fc07-4295-8bb2-a7099206e323',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tepsalesV1TemplatesIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '454e3400-c2fe-4f69-882f-f944a56a4583',
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetAllPagedTemplateResponse>> tepsalesV1TemplatesPagedGet({ 
    String? name,
    int? page,
    int? pageSize,
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = 'bd548938-2105-452d-a21b-a2484462db9c',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/tepsales/v1/templates/paged';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllPagedTemplateResponse),
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostTemplateResponse>> tepsalesV1TemplatesPost({ 
    String? xApiKey,
    String? xCsrfToken = '726ff7af-db3b-46f9-bef8-f53eea795864',
    ...
    final _path = r'/tepsales/v1/templates';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostTemplateResponse),
