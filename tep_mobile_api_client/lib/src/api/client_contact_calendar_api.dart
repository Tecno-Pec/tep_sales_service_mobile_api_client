...
class ClientContactCalendarApi {
  ...
  const ClientContactCalendarApi(this._dio, this._serializers);

  /// Get ClientContactCalendar by id
  /// 
  ///
  /// Parameters:
  /// * [id] - ClientContactCalendar id
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetAllClientContactCalendarResponse] as data
  ...
  Future<Response<GetAllClientContactCalendarResponse>> getByIdClientContactCalendar({ 
    ...
    final _path = r'/tepsales/v1/clientcontactcalendar/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    GetAllClientContactCalendarResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllClientContactCalendarResponse),
    ...
    return Response<GetAllClientContactCalendarResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GetAllClientContactCalendarResponse>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<GetAllClientContactCalendarResponse>>> tepsalesV1ClientcontactcalendarAllGet({ 
    DateTime? startDate,
    DateTime? endDate,
    String? clientId,
    String? clientName,
    ...
    final _path = r'/tepsales/v1/clientcontactcalendar/all';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    BuiltList<GetAllClientContactCalendarResponse>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GetAllClientContactCalendarResponse)]),
    ...
    return Response<BuiltList<GetAllClientContactCalendarResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tepsalesV1ClientcontactcalendarIdPatch({ 
    required String id,
  ...
  /// * [xApiKey] - Your Api Key
  /// * [xCsrfToken] - CSRF Protection
  /// * [putClientContactCalendarRequest] - ClientContactCalendar to update
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> tepsalesV1ClientcontactcalendarIdPut({ 
    ...
    try {
      const _type = FullType(PutClientContactCalendarRequest);
      _bodyData = putClientContactCalendarRequest == null ? null : _serializers.serialize(putClientContactCalendarRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetAllPagedClientContactCalendarResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetAllPagedClientContactCalendarResponse>> tepsalesV1ClientcontactcalendarPagedGet({ 
    DateTime? startDate,
    DateTime? endDate,
    String? clientId,
    String? clientName,
    ...
    final _path = r'/tepsales/v1/clientcontactcalendar/paged';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    GetAllPagedClientContactCalendarResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllPagedClientContactCalendarResponse),
    ...
    return Response<GetAllPagedClientContactCalendarResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [xApiKey] - Your Api Key
  /// * [xCsrfToken] - CSRF Protection
  /// * [postClientContactCalendarRequest] - ClientContactCalendar to create
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PostClientContactCalendarResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostClientContactCalendarResponse>> tepsalesV1ClientcontactcalendarPost({ 
    ...
    final _path = r'/tepsales/v1/clientcontactcalendar';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    try {
      const _type = FullType(PostClientContactCalendarRequest);
      _bodyData = postClientContactCalendarRequest == null ? null : _serializers.serialize(postClientContactCalendarRequest, specifiedType: _type);
    ...
    PostClientContactCalendarResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostClientContactCalendarResponse),
    ...
    return Response<PostClientContactCalendarResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
