...
class VehicleTypeApi {
  ...
  Future<Response<GetAllVehicleTypeResponse>> getByIdVehicleType({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'f4f39e54-d4d9-450a-a860-5bdd520d4732',
    ...
    final _path = r'/tepsales/v1/vehicleTypes/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllVehicleTypeResponse),
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<GetAllVehicleTypeResponse>>> tepsalesV1VehicleTypesAllGet({ 
    String? name,
    String? externalCode,
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = '909a9340-f685-4cb0-ab6e-238d76f8ac72',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/tepsales/v1/vehicleTypes/all';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (status != null) r'status': encodeQueryParameter(_serializers, status, const FullType(VehicleTypeStatus)),
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GetAllVehicleTypeResponse)]),
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tepsalesV1VehicleTypesIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '4a9fa60c-becb-4f5f-8591-28b0c46434e3',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tepsalesV1VehicleTypesIdPatch({ 
    required String id,
    required BuiltList<Operation> operation,
    String? xApiKey,
    String? xCsrfToken = '5504a653-2b80-4ec4-bfa6-fb73cf0b13b9',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tepsalesV1VehicleTypesIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '7e469b83-9985-482d-8123-068df020ac48',
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetAllPagedVehicleTypeResponse>> tepsalesV1VehicleTypesPagedGet({ 
    String? name,
    String? externalCode,
    VehicleTypeStatus? status,
    int? page,
    ...
    String? sort = 'Id.desc',
    String? xApiKey,
    String? xCsrfToken = 'a3a33977-9dcc-4d0b-a45c-affe8cd3d31b',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/tepsales/v1/vehicleTypes/paged';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllPagedVehicleTypeResponse),
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostVehicleTypeResponse>> tepsalesV1VehicleTypesPost({ 
    String? xApiKey,
    String? xCsrfToken = '46da20f8-7ac8-4e67-b838-53529c4dfd94',
    ...
    final _path = r'/tepsales/v1/vehicleTypes';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostVehicleTypeResponse),
