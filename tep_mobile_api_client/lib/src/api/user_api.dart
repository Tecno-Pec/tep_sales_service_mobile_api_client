...
class UserApi {
  ...
  Future<Response<GetAllUserResponse>> getByIdUser({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '25aa9bfe-8bc6-4d91-b3b5-5b8e1fbd2e08',
  ...
  Future<Response<GetAllUserResponse>> getUserInfo({ 
    String? xApiKey,
    String? xCsrfToken = '6b19377d-7d23-4e13-b606-c6c1d749ec90',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/tepsales/v1/users/userinfo';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
  ...
  Future<Response<BuiltList<GetAllUserResponse>>> tepsalesV1UsersAllGet({ 
    ...
    String? sort,
    String? xApiKey,
    String? xCsrfToken = 'aa77e268-c692-4b5b-b772-7d032c1ab6a5',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (documentId != null) r'documentId': encodeQueryParameter(_serializers, documentId, const FullType(String)),
      ...
      if (status != null) r'status': encodeQueryParameter(_serializers, status, const FullType(UserStatus)),
      if (isSalesman != null) r'isSalesman': encodeQueryParameter(_serializers, isSalesman, const FullType(bool)),
  ...
  /// * [xApiKey] - Your Api Key
  /// * [xCsrfToken] - CSRF Protection
  /// * [postUserForceChangePasswordRequest] - Force Change Password
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PostUserResetPasswordResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PostUserResetPasswordResponse>> tepsalesV1UsersForcerchangepasswordPost({ 
    String? xApiKey,
    String? xCsrfToken = '0cbcef50-0c3b-40a8-814b-6a4371eb5b9e',
    ...
    final _path = r'/tepsales/v1/users/forcerchangepassword';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    try {
      const _type = FullType(PostUserForceChangePasswordRequest);
      _bodyData = postUserForceChangePasswordRequest == null ? null : _serializers.serialize(postUserForceChangePasswordRequest, specifiedType: _type);
    ...
    PostUserResetPasswordResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostUserResetPasswordResponse),
    ...
    return Response<PostUserResetPasswordResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> tepsalesV1UsersIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '633ccb77-c56f-4f41-9fe8-d06d17dc958d',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1UsersIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = 'c6830b89-d79c-41e8-a568-cc482243d3d1',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> tepsalesV1UsersIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '08882333-e8d1-45f7-b860-b9cdb938e91d',
  ...
  Future<Response<GetAllPagedUserResponse>> tepsalesV1UsersPagedGet({ 
    ...
    String? sort,
    String? xApiKey,
    String? xCsrfToken = 'dc388da9-ca2c-4fd4-89d0-26d5f0ab6bdf',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllPagedUserResponse),
  ...
  Future<Response<PostUserResponse>> tepsalesV1UsersPost({ 
    String? xApiKey,
    String? xCsrfToken = '97858910-2420-4144-ba42-d8d010fa19d1',
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostUserResponse),
      ) as PostUserResponse;
  ...
  Future<Response<void>> tepsalesV1UsersPushtokenPost({ 
    String? xApiKey,
    String? xCsrfToken = '890a4bef-1c62-48f1-99fe-10ffd50fcc6c',
    ...
    final _path = r'/tepsales/v1/users/pushtoken';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
  ...
  /// * [xApiKey] - Your Api Key
  /// * [xCsrfToken] - CSRF Protection
  /// * [postUserResetPassword] - Reset Password
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<PostUserResetPasswordResponse>> tepsalesV1UsersResetPasswordPost({ 
    String? xApiKey,
    String? xCsrfToken = '45f1a632-f248-4930-b9f5-3882e46249f5',
    ...
    final _path = r'/tepsales/v1/users/reset_password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xApiKey != null) r'x-api-key': xApiKey,
    ...
    try {
      const _type = FullType(PostUserResetPassword);
      _bodyData = postUserResetPassword == null ? null : _serializers.serialize(postUserResetPassword, specifiedType: _type);
  ...
  Future<Response<PostUserSignInResponse>> tepsalesV1UsersSigninPost({ 
    String? xApiKey,
    String? xCsrfToken = '2c65c71e-e6a0-4d4d-9a86-c9bf4da494cf',
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostUserSignInResponse),
  ...
  Future<Response<PostUserResponse>> tepsalesV1UsersSignupPost({ 
    String? xApiKey,
    String? xCsrfToken = '73bf33b8-2e5f-49ec-bc0d-28d8fc06dfbb',
    PostUserRequest? postUserRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
