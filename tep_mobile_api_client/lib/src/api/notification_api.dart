...
class NotificationApi {
  ...
  Future<Response<GetAllNotificationResponse>> getByIdNotification({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = 'ed0bdaac-3c96-49b1-a499-be713208d3e5',
  ...
  Future<Response<GetAllPagedNotificationResponse>> yes4trackV1NotificationsGet({ 
    ...
    String? sort,
    String? xApiKey,
    String? xCsrfToken = '6057f5f6-b2c8-4600-a265-76893bfacec9',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1NotificationsIdDelete({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '2193fbdb-568e-41c5-924b-0425f300ff53',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1NotificationsIdPatch({ 
    ...
    String? xApiKey,
    String? xCsrfToken = '5fe42129-e035-46cc-9f19-a53bfde2a2ad',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> yes4trackV1NotificationsIdPut({ 
    required String id,
    String? xApiKey,
    String? xCsrfToken = '84081f13-67ec-4645-abaf-9abffdf9e762',
  ...
  Future<Response<PostNotificationResponse>> yes4trackV1NotificationsPost({ 
    String? xApiKey,
    String? xCsrfToken = '4b411484-a807-4e4b-b394-db92983d50e0',
