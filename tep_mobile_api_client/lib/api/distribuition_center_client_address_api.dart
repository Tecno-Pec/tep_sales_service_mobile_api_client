...
class DistribuitionCenterClientAddressApi {
  DistribuitionCenterClientAddressApi([ApiClient? apiClient])
  ...
  /// * [String] xCsrfToken:
  ///   CSRF Protection
  Future<http.Response> getByIdDistribuitionCenterClientAddressWithHttpInfo(
    String id, {
    String? xApiKey,
    String? xCsrfToken,
  }) async {
  ...
  /// * [String] xCsrfToken:
  ///   CSRF Protection
  Future<GetAllDistribuitionCenterClientAddressResponse?>
      getByIdDistribuitionCenterClientAddress(
    String id, {
    String? xApiKey,
    String? xCsrfToken,
  }) async {
    final response = await getByIdDistribuitionCenterClientAddressWithHttpInfo(
      id,
      xApiKey: xApiKey,
  ...
  Future<http.Response>
      tepsalesV1DistribuitionCenterClientAddressAllGetWithHttpInfo({
    String? distribuitionCenterId,
    String? addressId,
    String? externalCode,
    DistribuitionCenterClientAddressStatus? status,
    ...
    if (distribuitionCenterId != null) {
      queryParams.addAll(
          _queryParams('', 'distribuitionCenterId', distribuitionCenterId));
    }
    if (addressId != null) {
  ...
  /// * [String] xCsrfToken:
  ///   CSRF Protection
  Future<List<GetAllDistribuitionCenterClientAddressResponse>?>
    ...
    final response =
        await tepsalesV1DistribuitionCenterClientAddressAllGetWithHttpInfo(
    ...
    if (response.body.isNotEmpty &&
      ...
      return (await apiClient.deserializeAsync(responseBody,
              'List<GetAllDistribuitionCenterClientAddressResponse>') as List)
  ...
  ///   CSRF Protection
  Future<http.Response>
      tepsalesV1DistribuitionCenterClientAddressIdDeleteWithHttpInfo(
    String id, {
    String? xApiKey,
    String? xCsrfToken,
  }) async {
  ...
  /// * [String] xCsrfToken:
  ///   CSRF Protection
  Future<void> tepsalesV1DistribuitionCenterClientAddressIdDelete(
    String id, {
    String? xApiKey,
    String? xCsrfToken,
  }) async {
    final response =
        await tepsalesV1DistribuitionCenterClientAddressIdDeleteWithHttpInfo(
      id,
      xApiKey: xApiKey,
      xCsrfToken: xCsrfToken,
    );
  ...
  ///   CSRF Protection
  Future<http.Response>
      tepsalesV1DistribuitionCenterClientAddressIdPatchWithHttpInfo(
    String id,
  ...
  /// * [String] xCsrfToken:
  ///   CSRF Protection
  Future<void> tepsalesV1DistribuitionCenterClientAddressIdPatch(
    String id,
    List<Operation> operation, {
    String? xApiKey,
    String? xCsrfToken,
    ...
    final response =
        await tepsalesV1DistribuitionCenterClientAddressIdPatchWithHttpInfo(
      id,
      operation,
      xApiKey: xApiKey,
      xCsrfToken: xCsrfToken,
  ...
  Future<http.Response> tepsalesV1DistribuitionCenterClientAddressIdPutWithHttpInfo(
    String id, {
    String? xApiKey,
    String? xCsrfToken,
  ...
  /// * [PutDistribuitionCenterClientAddressRequest] putDistribuitionCenterClientAddressRequest:
  ///   DistribuitionCenterClientAddress to update
  Future<void> tepsalesV1DistribuitionCenterClientAddressIdPut(
    String id, {
    String? xApiKey,
    String? xCsrfToken,
    PutDistribuitionCenterClientAddressRequest?
    ...
    final response =
        await tepsalesV1DistribuitionCenterClientAddressIdPutWithHttpInfo(
      id,
      xApiKey: xApiKey,
      xCsrfToken: xCsrfToken,
      putDistribuitionCenterClientAddressRequest:
  ...
  ///   CSRF Protection
  Future<http.Response>
      tepsalesV1DistribuitionCenterClientAddressPagedGetWithHttpInfo({
    String? distribuitionCenterId,
    String? addressId,
    String? externalCode,
    DistribuitionCenterClientAddressStatus? status,
  ...
  /// * [String] xCsrfToken:
  ///   CSRF Protection
  Future<GetAllPagedDistribuitionCenterClientAddressResponse?>
    ...
    final response =
        await tepsalesV1DistribuitionCenterClientAddressPagedGetWithHttpInfo(
      distribuitionCenterId: distribuitionCenterId,
      addressId: addressId,
      externalCode: externalCode,
      status: status,
  ...
  Future<http.Response> tepsalesV1DistribuitionCenterClientAddressPostWithHttpInfo({
    String? xApiKey,
    String? xCsrfToken,
  ...
  /// * [PostDistribuitionCenterClientAddressRequest] postDistribuitionCenterClientAddressRequest:
  ///   DistribuitionCenterClientAddress to create
  Future<PostDistribuitionCenterClientAddressResponse?>
    ...
    final response =
        await tepsalesV1DistribuitionCenterClientAddressPostWithHttpInfo(
      xApiKey: xApiKey,
      xCsrfToken: xCsrfToken,
      postDistribuitionCenterClientAddressRequest:
          postDistribuitionCenterClientAddressRequest,
