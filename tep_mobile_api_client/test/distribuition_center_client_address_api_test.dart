...
void main() {
  final instance = TepMobileApiClient().getDistribuitionCenterClientAddressApi();
  ...
  group(DistribuitionCenterClientAddressApi, () {
    ...
    //
    //Future<BuiltList<GetAllDistribuitionCenterClientAddressResponse>> tepsalesV1DistribuitionCenterClientAddressAllGet({ String distribuitionCenterId, String addressId, String externalCode, DistribuitionCenterClientAddressStatus status, int limit, String sort, String xApiKey, String xCsrfToken }) async
