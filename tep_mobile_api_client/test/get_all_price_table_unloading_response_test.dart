...
// tests for GetAllPriceTableUnloadingResponse
void main() {
  final instance = GetAllPriceTableUnloadingResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetAllPriceTableUnloadingResponse, () {
    // DateTime createdAt
    ...
    // double valueOfKG
    test('to test the property `valueOfKG`', () async {
      // TODO
    });
