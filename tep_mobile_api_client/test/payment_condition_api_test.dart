...
void main() {
  final instance = PaymentConditionApi();

  group('tests for PaymentConditionApi', () {
    ...
    //
    //Future tepsalesV1PaymentConditionsIdPatch(String id, List<Operation> operation, { String xApiKey, String xCsrfToken }) async
