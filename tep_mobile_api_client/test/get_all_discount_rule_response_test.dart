...
// tests for GetAllDiscountRuleResponse
void main() {
  final instance = GetAllDiscountRuleResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetAllDiscountRuleResponse, () {
    // DateTime createdAt
    ...
    test('to test the property `discountWeightType`', () async {
      // TODO
    });
