...
// tests for GetAllIntegrationStatusResponse
void main() {
  final instance = GetAllIntegrationStatusResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetAllIntegrationStatusResponse, () {
    // DateTime createdAt
    ...
    test('to test the property `quantityEntities`', () async {
      // TODO
    });
