...
// tests for PutDistribuitionCenterClientAddressRequest
void main() {
  final instance = PutDistribuitionCenterClientAddressRequestBuilder();
  // TODO add properties to the builder and call build()

  group(PutDistribuitionCenterClientAddressRequest, () {
    // DateTime createdAt
