...
// tests for GetAllFreightTableResponse
void main() {
  final instance = GetAllFreightTableResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetAllFreightTableResponse, () {
    // DateTime createdAt
    ...
    test('to test the property `initialKilometer`', () async {
      // TODO
    });

    // double finalKilometer
    test('to test the property `finalKilometer`', () async {
      // TODO
    });
    ...
    // bool isFractional
    test('to test the property `isFractional`', () async {
      // TODO
    });
