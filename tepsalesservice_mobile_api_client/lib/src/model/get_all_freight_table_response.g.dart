...
class _$GetAllFreightTableResponse extends GetAllFreightTableResponse {
  ...
  factory _$GetAllFreightTableResponse(
      ...
      (new GetAllFreightTableResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllFreightTableResponse')
...
class GetAllFreightTableResponseBuilder
  ...
  @override
  _$GetAllFreightTableResponse build() {
    final _$result = _$v ??
