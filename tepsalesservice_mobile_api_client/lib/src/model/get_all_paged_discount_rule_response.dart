...
class _$GetAllPagedDiscountRuleResponseSerializer implements StructuredSerializer<GetAllPagedDiscountRuleResponse> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllPagedDiscountRuleResponse object,
    ...
    @override
    GetAllPagedDiscountRuleResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllDiscountRuleResponse)])) as BuiltList<GetAllDiscountRuleResponse>?;
