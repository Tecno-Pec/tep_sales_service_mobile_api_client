...
class _$GetAllPagedPriceTableResponseSerializer implements StructuredSerializer<GetAllPagedPriceTableResponse> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllPagedPriceTableResponse object,
    ...
    @override
    GetAllPagedPriceTableResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllPriceTableResponse)])) as BuiltList<GetAllPriceTableResponse>?;
