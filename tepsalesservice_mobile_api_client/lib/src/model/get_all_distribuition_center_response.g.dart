...
class _$GetAllDistribuitionCenterResponse
  ...
  factory _$GetAllDistribuitionCenterResponse(
      ...
      (new GetAllDistribuitionCenterResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllDistribuitionCenterResponse')
...
class GetAllDistribuitionCenterResponseBuilder
  ...
  @override
  _$GetAllDistribuitionCenterResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllDistribuitionCenterResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
