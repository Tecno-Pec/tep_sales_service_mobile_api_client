...
part 'put_product_request.g.dart';
...
/// * [discountRules] 
/// * [discountCommission] 
abstract class PutProductRequest implements Built<PutProductRequest, PutProductRequestBuilder> {
    ...
    static void _defaults(PutProductRequestBuilder b) => b;

    factory PutProductRequest([void updates(PutProductRequestBuilder b)]) = _$PutProductRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<PutProductRequest> get serializer => _$PutProductRequestSerializer();
}

class _$PutProductRequestSerializer implements StructuredSerializer<PutProductRequest> {
    @override
    final Iterable<Type> types = const [PutProductRequest, _$PutProductRequest];

    @override
    final String wireName = r'PutProductRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, PutProductRequest object,
    ...
    @override
    PutProductRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PutProductRequestBuilder();
