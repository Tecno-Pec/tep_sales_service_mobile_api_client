...
class _$GetAllPagedAddressResponseSerializer implements StructuredSerializer<GetAllPagedAddressResponse> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllPagedAddressResponse object,
    ...
    @override
    GetAllPagedAddressResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllAddressResponse)])) as BuiltList<GetAllAddressResponse>?;
