...
class _$GetAllPagedProductGroupResponseSerializer implements StructuredSerializer<GetAllPagedProductGroupResponse> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllPagedProductGroupResponse object,
    ...
    @override
    GetAllPagedProductGroupResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'results':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(BuiltList, [FullType(GetAllProductGroupResponse)])) as BuiltList<GetAllProductGroupResponse>?;
