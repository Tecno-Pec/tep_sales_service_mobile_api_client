...
/// * [type] 
/// * [externalCode] 
abstract class GetAllAddressResponse implements Built<GetAllAddressResponse, GetAllAddressResponseBuilder> {
    ...
    GetAllAddressResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(GetAllAddressResponseBuilder b) => b;

    factory GetAllAddressResponse([void updates(GetAllAddressResponseBuilder b)]) = _$GetAllAddressResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<GetAllAddressResponse> get serializer => _$GetAllAddressResponseSerializer();
}

class _$GetAllAddressResponseSerializer implements StructuredSerializer<GetAllAddressResponse> {
    @override
    final Iterable<Type> types = const [GetAllAddressResponse, _$GetAllAddressResponse];

    @override
    final String wireName = r'GetAllAddressResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, GetAllAddressResponse object,
    ...
    @override
    GetAllAddressResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = GetAllAddressResponseBuilder();
