...
part 'post_freight_response.g.dart';
...
/// * [weightClass] 
abstract class PostFreightResponse implements Built<PostFreightResponse, PostFreightResponseBuilder> {
    ...
    PostFreightResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(PostFreightResponseBuilder b) => b;

    factory PostFreightResponse([void updates(PostFreightResponseBuilder b)]) = _$PostFreightResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<PostFreightResponse> get serializer => _$PostFreightResponseSerializer();
}

class _$PostFreightResponseSerializer implements StructuredSerializer<PostFreightResponse> {
    @override
    final Iterable<Type> types = const [PostFreightResponse, _$PostFreightResponse];

    @override
    final String wireName = r'PostFreightResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, PostFreightResponse object,
    ...
    @override
    PostFreightResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PostFreightResponseBuilder();
