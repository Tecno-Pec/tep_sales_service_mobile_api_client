...
class _$GetAllPagedPriceTableResponse extends GetAllPagedPriceTableResponse {
  ...
  factory _$GetAllPagedPriceTableResponse(
      ...
      (new GetAllPagedPriceTableResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllPagedPriceTableResponse')
...
class GetAllPagedPriceTableResponseBuilder
  ...
  @override
  _$GetAllPagedPriceTableResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllPagedPriceTableResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
