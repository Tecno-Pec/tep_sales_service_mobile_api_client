...
part 'put_freight_request.g.dart';
...
/// * [weightClass] 
abstract class PutFreightRequest implements Built<PutFreightRequest, PutFreightRequestBuilder> {
    ...
    static void _defaults(PutFreightRequestBuilder b) => b;

    factory PutFreightRequest([void updates(PutFreightRequestBuilder b)]) = _$PutFreightRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<PutFreightRequest> get serializer => _$PutFreightRequestSerializer();
}

class _$PutFreightRequestSerializer implements StructuredSerializer<PutFreightRequest> {
    @override
    final Iterable<Type> types = const [PutFreightRequest, _$PutFreightRequest];

    @override
    final String wireName = r'PutFreightRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, PutFreightRequest object,
    ...
    @override
    PutFreightRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = PutFreightRequestBuilder();
