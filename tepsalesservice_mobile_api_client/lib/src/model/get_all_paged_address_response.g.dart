...
class _$GetAllPagedAddressResponse extends GetAllPagedAddressResponse {
  ...
  factory _$GetAllPagedAddressResponse(
      ...
      (new GetAllPagedAddressResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetAllPagedAddressResponse')
...
class GetAllPagedAddressResponseBuilder
  ...
  @override
  _$GetAllPagedAddressResponse build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GetAllPagedAddressResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
