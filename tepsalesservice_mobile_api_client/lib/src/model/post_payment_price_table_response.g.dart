...
class _$PostPaymentPriceTableResponse extends PostPaymentPriceTableResponse {
  ...
  factory _$PostPaymentPriceTableResponse(
      ...
      (new PostPaymentPriceTableResponseBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostPaymentPriceTableResponse')
...
class PostPaymentPriceTableResponseBuilder
  ...
  @override
  _$PostPaymentPriceTableResponse build() {
    final _$result = _$v ??
