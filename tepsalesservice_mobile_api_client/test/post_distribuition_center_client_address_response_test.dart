...
// tests for PostDistribuitionCenterClientAddressResponse
void main() {
  final instance = PostDistribuitionCenterClientAddressResponseBuilder();
  // TODO add properties to the builder and call build()

  group(PostDistribuitionCenterClientAddressResponse, () {
    // DateTime createdAt
