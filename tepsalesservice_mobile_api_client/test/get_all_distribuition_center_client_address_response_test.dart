...
// tests for GetAllDistribuitionCenterClientAddressResponse
void main() {
  final instance = GetAllDistribuitionCenterClientAddressResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetAllDistribuitionCenterClientAddressResponse, () {
    // DateTime createdAt
