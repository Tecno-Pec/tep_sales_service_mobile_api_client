...
void main() {
  final instance = TepsalesserviceMobileApiClient().getPaymentConditionApi();
  ...
  group(PaymentConditionApi, () {
    ...
    //
    //Future<BuiltList<GetAllPaymentConditionResponse>> tepsalesV1PaymentConditionsAllGet({ String name, String externalCode, int limit, String sort, String xApiKey, String xCsrfToken }) async
    ...
    //
    //Future<GetAllPagedPaymentConditionResponse> tepsalesV1PaymentConditionsPagedGet({ String name, String externalCode, int page, int pageSize, String sort, String xApiKey, String xCsrfToken }) async
