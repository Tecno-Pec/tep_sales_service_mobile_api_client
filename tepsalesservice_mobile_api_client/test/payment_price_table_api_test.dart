...
void main() {
  final instance = TepsalesserviceMobileApiClient().getPaymentPriceTableApi();
  ...
  group(PaymentPriceTableApi, () {
    ...
    //
    //Future<BuiltList<GetAllPaymentPriceTableResponse>> tepsalesV1PaymentPriceTablesAllGet({ String paymentConditionId, String priceTableId, int limit, String sort, String xApiKey, String xCsrfToken }) async
    ...
    //
    //Future<GetAllPagedPaymentPriceTableResponse> tepsalesV1PaymentPriceTablesPagedGet({ String paymentConditionId, String priceTableId, int page, int pageSize, String sort, String xApiKey, String xCsrfToken }) async
